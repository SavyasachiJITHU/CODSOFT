...
if __name__ == "__main__" :
	...
	gui.geometry("580x280")

	# create a label : Enter Your Task
	enterTask = Label(gui, text = "Enter Your Task: ",font=("Lucida",10,"bold"), bg = "light green")
	...
	# the command or function affiliated to that button is executed
        ...
        #To-do list visible
	todolist=Label(gui,text="---YOUR TO-DO List----",font=("Lucida",10,"bold"),bg="light green")
	...
	#finished tasks 
	finish = Label(gui, text = "Delete the Completed Tasks", font=("Lucida",10,"bold"),bg = "light green")
	finish.grid(row = 6, column = 2)
	
	# create a label : Delete Task Number
	taskNumber = Label(gui, text = "Completed-Task Number:", font=("Lucida",10,"bold"),bg = "light green")
